...
(cl-bladerf::with-bladerf-device (dev1 "")
  ...
  (setf (cffi:mem-aref *dword-bytes* :uint32 0)  #b00000000000000000000000000000011) ; This is the number of Dwords in the transport block
  ...
  (setf (cffi:mem-aref *dword-bytes* :uint32 3)  #b00000000000000000000000000001101)
  ...
  (cl-bladerf::bladerf_sync_tx dev1 *dword-bytes*  4   (cffi:null-pointer)  1000) )
